...
class RecommandationService:
    ...
    def get_recommendations(self, params: Traits) -> List[Song]:
        try:
            response = self._make_request("GET", f"{self.spotify_adapter_url}/recommendations", params=params.model_dump())
